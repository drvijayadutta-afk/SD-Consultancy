...
const industries = [
  'Hospital Chain',
  'Specialty Hospital (incl. Fertility & IVF)',
  'Diagnostics Network',
  'HealthTech',
  'MedTech',
  'Pharmaceutical',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="max-w-3xl">
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full border border-[#3E5776]/40 bg-[#3E5776]/10">
              <span className="text-[#8393a7] text-xs font-semibold tracking-widest uppercase">Get In Touch</span>
            </div>
          ...
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-1 space-y-8">
              ...
              <AnimatedSection delay={100}>
                <div className="space-y-5">
                  <a
                    ...
                    className="flex items-start gap-4 p-5 bg-[#f8fafc] dark:bg-[#162d4a] rounded-xl border border-gray-100 dark:border-white/5 hover:border-[#25405F]/40 transition-colors group"
                  >
                    <div className="w-10 h-10 rounded-xl bg-[#E7EAEF] flex items-center justify-center flex-shrink-0">
                      <Mail className="w-5 h-5 text-[#25405F]" />
                    </div>
                    <div>
                      <div className="text-xs font-semibold text-[#3A3A3A]/75 dark:text-white/60 uppercase tracking-wide mb-1">Email</div>
                      <div className="font-medium text-[#101E36] dark:text-white group-hover:text-[var(--text-blue)] transition-colors">drvijayadutta@gmail.com</div>
                    </div>
                  </a>

                  <div className="flex items-start gap-4 p-5 bg-[#f8fafc] dark:bg-[#162d4a] rounded-xl border border-gray-100 dark:border-white/5">
                    <div className="w-10 h-10 rounded-xl bg-[#F3EEE0] flex items-center justify-center flex-shrink-0">
                      <MapPin className="w-5 h-5 text-[#25405F]" />
                    </div>
                    <div>
                      <div className="text-xs font-semibold text-[#3A3A3A]/75 dark:text-white/60 uppercase tracking-wide mb-1">Office</div>
                      <div className="font-medium text-[#101E36] dark:text-white">New Delhi</div>
              ...
              <AnimatedSection delay={200}>
                <h3 className="font-semibold text-[#101E36] dark:text-white mb-4">What can we help with?</h3>
            ...
            <AnimatedSection direction="right" className="lg:col-span-2">
              {submitted ? (
                <div className="flex flex-col items-center justify-center h-full min-h-[500px] text-center bg-[#f8fafc] dark:bg-[#162d4a] rounded-3xl p-12 border border-gray-100 dark:border-white/5">
                  <div className="w-20 h-20 rounded-full bg-[#3E5776]/15 flex items-center justify-center mb-6">
                    <CheckCircle2 className="w-10 h-10 text-[#3E5776]" />
                  </div>
                  <h2 className="text-2xl font-bold font-heading text-[#101E36] dark:text-white mb-4">
                    Thank You, {form.name.split(' ')[0]}!
                  </h2>
                  <p className="text-[#3A3A3A]/75 dark:text-white/60 max-w-md leading-relaxed">
                    We&apos;ve received your enquiry and will respond within 24 hours with our initial perspective on how SD Square Consulting can help {form.organization} achieve its healthcare brand goals.
                  </p>
                </div>
              ) : (
                <form
                ...
                >
                  <h2 className="text-xl font-bold font-heading text-[#101E36] dark:text-white mb-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-5 mb-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#0f1923] text-[#3A3A3A] dark:text-white placeholder:text-gray-400 dark:placeholder:text-white/55 focus:outline-none focus:border-[#25405F] transition-colors"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-[#3A3A3A] dark:text-white/80 mb-2">
                  ...
                  <div className="grid md:grid-cols-2 gap-5 mb-5">
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        required
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#0f1923] text-[#3A3A3A] dark:text-white focus:outline-none focus:border-[#25405F] transition-colors"
                      >
                  ...
                  <div className="mb-8">
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 dark:border-white/10 bg-white dark:bg-[#0f1923] text-[#3A3A3A] dark:text-white placeholder:text-gray-400 dark:placeholder:text-white/55 focus:outline-none focus:border-[#25405F] transition-colors resize-none"
                    />
                  </div>

                  <button
                    type="submit"
                    className="w-full flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-[#101E36] to-[#25405F] text-white font-bold rounded-xl hover:shadow-xl hover:shadow-[#25405F]/30 hover:-translate-y-0.5 transition-all"
                  >
