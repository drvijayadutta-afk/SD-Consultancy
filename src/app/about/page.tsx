...
export const metadata: Metadata = {
  ...
  description: 'S.D Consultancy was founded by Dr. Vijaya Dutta — BDS, Rank 14 IP University, formerly of Max Hospital and Manipal Hospital. India\'s premier 360° healthcare brand strategy consultancy.',
};
...
const timeline = [
  { year: '2018', event: 'Dr. Vijaya Dutta completed BDS from ESIC Dental College, ranking 14th in IP University — a foundation of clinical excellence that would inform every strategic decision ahead' },
  { year: '2018', event: 'Joined Max Hospital — one of India\'s premier hospital networks — gaining deep exposure to healthcare brand-building, patient communications, and multi-specialty marketing at scale' },
  { year: '2020', event: 'Moved to Manipal Hospital, expanding expertise across complex healthcare ecosystems — referral networks, specialist positioning, and integrated communications across multiple verticals' },
  { year: '2022', event: 'Developed the foundational principles of the HCLF™ Framework — crystallizing years of frontline healthcare marketing experience into a structured, repeatable methodology' },
  { year: '2024', event: 'Led brand strategy and communications for multiple healthcare organizations simultaneously, building a network of strategists, creatives, and digital specialists' },
  { year: '2026', event: 'Founded S.D Consultancy — channelling clinical credibility and years of premium healthcare marketing experience into India\'s premier 360° healthcare brand strategy consultancy' },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="max-w-3xl">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-heading text-white leading-tight mb-6">
              Founded by Dr. Vijaya Dutta.{' '}
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4F8A77] to-[#B8924A]">
                Built for Healthcare Leaders.
              </span>
            </h1>
            <p className="text-lg text-white/65 leading-relaxed">
              S.D Consultancy is India&apos;s premier 360° healthcare brand, communications, and creative strategy consultancy — founded by a BDS graduate who ranked 14th in IP University and honed her expertise at Max Hospital and Manipal Hospital.
            </p>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section className="py-24 bg-white dark:bg-[#0f1923]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection>
              <SectionHeader eyebrow="Our Story" title="A Dentist Who Chose Strategy" />
              <div className="mt-6 space-y-5 text-[#3A3A3A]/70 dark:text-white/60 leading-relaxed">
                <p>
                  S.D Consultancy was founded by Dr. Vijaya Dutta — who ranked 14th in IP University and completed her BDS in 2018 from ESIC Dental College. After graduating, she went on to work with two of India&apos;s most respected hospital groups: Max Hospital and Manipal Hospital.
                </p>
                <p>
                  Those years on the frontlines of premium healthcare gave Dr. Dutta a rare vantage point: she saw firsthand how organizations with world-class clinical capabilities consistently struggled to communicate their excellence to patients, physicians, and partners.
                </p>
                <p>
                  That insight became the foundation of S.D Consultancy and the HCLF™ Framework — a proprietary methodology built on clinical credibility and strategic rigor that no generalist agency can replicate.
                </p>
              </div>
              ...
              <div className="mt-8 flex items-center gap-4 p-5 bg-[#f8fafc] dark:bg-[#162d4a] rounded-2xl border border-gray-100 dark:border-white/5">
                ...
                <div>
                  <div className="font-bold text-[#1F3A5F] dark:text-white font-heading">Dr. Vijaya Dutta</div>
                  <div className="text-sm text-[#4F8A77] font-medium">Founder & Chief Strategy Officer</div>
                  <div className="text-xs text-[#3A3A3A]/50 dark:text-white/40 mt-0.5">BDS · Rank 14, IP University · Max Hospital · Manipal Hospital · Founded 2026</div>
                </div>
              </div>
            </AnimatedSection>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            ...
            <div className="space-y-10">
              {timeline.map((item, i) => (
                <AnimatedSection key={item.year + i} delay={i * 100}>
