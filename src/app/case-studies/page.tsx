...
const caseStudies = [
  {
    id: 'multi-specialty-rebrand', category: 'Hospital Chain', color: '#2E75B6', badge: 'Brand Transformation',
  ...
  {
    id: 'ivf-chain-positioning', category: 'IVF & Fertility', color: '#4F8A77', badge: 'Brand Positioning',
  ...
  {
    id: 'diagnostics-premium', category: 'Diagnostics Network', color: '#1F3A5F', badge: 'Premium Positioning',
  ...
  {
    id: 'healthtech-gtm', category: 'HealthTech', color: '#B8924A', badge: 'Go-to-Market Strategy',
      ...
      <section className="hero-gradient pt-32 pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="max-w-3xl">
            ...
            <p className="text-lg text-white/65 leading-relaxed">Real strategies, real implementations, real results. Explore how we&apos;ve helped healthcare organizations achieve market leadership across sectors.</p>
          </AnimatedSection>
        </div>
      </section>
                ...
                <div className={`rounded-3xl overflow-hidden border border-gray-100 dark:border-white/5 ${idx % 2 === 0 ? 'bg-[#f8fafc] dark:bg-[#162d4a]' : 'bg-white dark:bg-[#0f1923]'}`}>
                  ...
                  <div className="p-8 md:p-12">
                    <div className="flex flex-wrap items-center gap-3 mb-6">
                      <span className="text-xs font-semibold px-3 py-1.5 rounded-full" style={{ color: cs.color, backgroundColor: cs.color + '15' }}>{cs.category}</span>
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4">
                      <div className="flex flex-wrap gap-2">
                        {cs.services.map((s) => (
                          <span key={s} className="text-xs px-3 py-1 rounded-full font-medium border" style={{ color: cs.color, borderColor: cs.color + '30' }}>{s}</span>
                        ))}
                      </div>
                      <Link href="/contact" className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-sm text-white hover:-translate-y-0.5 transition-all" style={{ backgroundColor: cs.color }}>
