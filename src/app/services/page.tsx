        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection className="max-w-3xl">
            <div className="inline-flex items-center gap-2 mb-6 px-4 py-2 rounded-full border border-[#3E5776]/40 bg-[#3E5776]/10">
              <span className="text-[#8393a7] text-xs font-semibold tracking-widest uppercase">Our Services</span>
            </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="grid lg:grid-cols-2 gap-16 items-start">
              <AnimatedSection>
                ...
                <h2 className="text-3xl md:text-4xl font-bold font-heading text-[#101E36] dark:text-white mb-5">
                  {service.title}
                </h2>
                <p className="text-[#3A3A3A]/75 dark:text-white/60 leading-relaxed mb-8">{service.overview}</p>
                <div className="mb-8">
                  <h3 className="font-semibold text-[#101E36] dark:text-white mb-4">Key Benefits</h3>
                ...
                <div>
                  <h3 className="font-semibold text-[#101E36] dark:text-white mb-3">Key Deliverables</h3>
                ...
                <div className="grid gap-4">
                  {service.offerings.map((offering) => (
                    <div key={offering.name}
                      ...
                      <h4 className="font-semibold font-heading text-[#101E36] dark:text-white mb-1.5">{offering.name}</h4>
