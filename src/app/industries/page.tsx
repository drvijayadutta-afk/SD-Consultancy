...
const industries = [
  {
    ...
    challenges: [
      'Inconsistent brand identity across locations',
      'Complex multi-stakeholder communications',
      'Physician recruitment and retention communications',
      'Competing with specialized boutique providers',
      'Balancing institutional authority with patient-centricity',
    ],
    opportunities: [
      'Network strength as a competitive moat',
      'Cross-referral pathway optimization',
      'Institutional thought leadership building',
      'Digital patient acquisition at scale',
    ],
    outcomes: [
      '30-45% increase in digital patient inquiries',
      'Improved physician referral rates',
      'Stronger inter-location brand consistency',
      'Premium positioning in key service lines',
    ],
  ...
  },
  {
    ...
    challenges: [
      'Communicating clinical excellence to non-clinical audiences',
      'Building referral networks with general practitioners',
      'Differentiating from multi-specialty competition',
      'Attracting international patients in select specialties',
      'KOL and specialist reputation management',
    ],
    opportunities: [
      'Clinical leadership as brand equity',
      'Outcome data as marketing asset',
      'International patient attraction programs',
      'KOL-driven thought leadership',
    ],
    outcomes: [
      'Established specialty brand authority',
      'Measurable increase in physician referrals',
      'Premium pricing sustainability',
      'National or regional brand recognition',
    ],
  ...
  },
  {
    ...
    challenges: [
      'Price competition eroding brand value',
      'Physician loyalty in a commoditizing market',
      'Home collection and B2C digital acquisition',
      'Quality perception vs. budget players',
      'Report turnaround and accuracy communication',
    ],
    opportunities: [
      'Quality and accuracy as premium differentiator',
      'B2C digital acquisition through patient convenience',
      'Corporate health check programs',
      'Preventive health positioning',
    ],
    outcomes: [
      'Premium positioning in target markets',
      'Improved physician loyalty scores',
      'Digital home-collection growth',
  ...
  },
  {
    ...
    challenges: [
      'Balancing clinical science with emotional empathy',
      'Building patient trust in an intimate, vulnerable context',
      'Communicating success rates ethically and compellingly',
      'Digital presence in a highly competitive market',
      'Cultural sensitivity across diverse patient demographics',
    ],
    opportunities: [
      'Story-driven patient testimonials and journeys',
      'Thought leadership in fertility science',
      'Community building for fertility patients',
      'Digital-first patient acquisition programs',
    ],
    outcomes: [
      'Trusted fertility brand identity',
      'Increased consultation bookings',
      'Strong patient community and advocacy',
      'Ethical differentiation on outcomes',
    ],
  ...
  },
  {
    ...
    challenges: [
      'Translating technology into clinical value',
      'B2B clinical buyer acquisition vs. B2C patient growth',
      'Building trust in a nascent regulatory environment',
      'Competing for attention in a crowded digital health market',
      'Aligning investor narrative with brand strategy',
    ],
    opportunities: [
      'First-mover advantage in emerging digital health categories',
      'Clinical validation as brand equity',
      'Partnership with hospital systems and clinics',
      'Patient adoption through behaviour design',
    ],
    outcomes: [
      'Credible clinical brand positioning',
      'Accelerated B2B sales pipeline',
      'Patient app adoption and retention',
      'Investor-aligned brand narrative',
    ],
  ...
  },
  {
    ...
    challenges: [
      'HCP education on new devices and technologies',
      'Market access and reimbursement communications',
      'KOL development and clinical champion programs',
      'Regulatory constraint on promotional claims',
      'Global brand with local clinical needs',
    ],
    opportunities: [
      'Clinical data as brand asset',
      'Surgical training and certification programs',
      'Regional KOL development programs',
      'Hospital procurement communications',
    ],
    outcomes: [
      'Accelerated clinical adoption',
      'Established HCP thought leadership',
      'Improved market access outcomes',
      'Stronger distributor and channel brand',
    ],
