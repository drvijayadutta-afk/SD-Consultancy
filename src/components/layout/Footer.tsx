    ...
    <div className="text-[#4F8A77] text-[10px] tracking-widest uppercase">360° Healthcare Strategy</div>
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
            ...
            {subscribed ? (
              ...
              <form onSubmit={handleSubscribe} className="flex gap-2 w-full md:w-auto">
                ...
                <button
                  type="submit"
                  className="px-5 py-2.5 bg-[#2E75B6] text-white text-sm font-semibold rounded-lg hover:bg-[#1F3A5F] transition-colors flex items-center gap-2"
                >
                  Subscribe
                </button>
              </form>
        ...
        <div className="mt-10 pt-6 border-t border-white/10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-white/40">
            © {new Date().getFullYear()} S.D Consultancy. All rights reserved.
          </p>
