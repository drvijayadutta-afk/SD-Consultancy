        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
          {differences.map((item, i) => (
            <AnimatedSection key={item.title} delay={i * 100}>
              <div className="group relative bg-[#f8fafc] dark:bg-[#111c2e] rounded-2xl p-7 h-full border border-gray-100/80 dark:border-white/5 hover:border-transparent hover:shadow-2xl hover:shadow-[#1F3A5F]/10 dark:hover:shadow-black/30 transition-all duration-400 overflow-hidden">
                ...
                <p className="text-sm text-[#3A3A3A]/60 dark:text-white/50 leading-relaxed">
                  {item.description}
                </p>
