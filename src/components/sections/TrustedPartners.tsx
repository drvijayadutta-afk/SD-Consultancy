        ...
        <div className="flex animate-marquee whitespace-nowrap">
          {[...partners, ...partners].map((partner, i) => (
            <div key={i} className="inline-flex items-center mx-8">
              <span className="text-[#3A3A3A]/40 dark:text-white/25 font-bold text-sm tracking-widest uppercase select-none hover:text-[#2E75B6]/70 dark:hover:text-[#2E75B6]/60 transition-colors duration-300">
                {partner}
              </span>
