    ...
    <section className="py-28 bg-[#f8fafc] dark:bg-[#0d1520]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {industries.map((ind, i) => (
            <AnimatedSection key={ind.label} delay={i * 80}>
              <Link
                href={ind.href}
                className="group flex gap-5 bg-white dark:bg-[#111c2e] rounded-2xl p-6 border border-gray-100 dark:border-white/5 hover:border-transparent hover:shadow-xl hover:shadow-[#101E36]/8 dark:hover:shadow-black/30 transition-all duration-300 hover:-translate-y-1"
              >
                <div
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold font-heading text-[#101E36] dark:text-white mb-1.5 group-hover:text-[var(--text-blue)] transition-colors">
                    {ind.label}
                  </h3>
        ...
        <AnimatedSection delay={500} className="text-center mt-12">
          <Link
            href="/industries"
            className="inline-flex items-center gap-2 px-7 py-3.5 bg-gradient-to-r from-[#101E36] to-[#25405F] text-white font-semibold rounded-xl hover:shadow-lg hover:shadow-[#25405F]/30 hover:-translate-y-0.5 transition-all duration-200 text-sm"
          >
            View All Industries
